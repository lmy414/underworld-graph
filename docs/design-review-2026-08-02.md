...
>
> 更新（2026-08-05）：A 类 7 项已在 0.1.1 修复；B 类 4 项（B1-B4，即 P1-3 原子性 /
> 幂等 / 日志容错与 P2-5 相关项）已在 0.1.2 修复，明细与回归测试见 `DEPLOYMENT.md` §9.2。
> 其余 C/D 类及性能项（B5）仍待与消费方对齐后处理。
>
> 更新（2026-08-07）：B5/C1-C4/D1-D5/D7/D8 已在 0.2.0 修复；D6 仍暂缓。
>
